    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container px-5">
                <a class="navbar-brand" href="#!">International College</a>
                <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        <li class="nav-item"><a class="nav-link active" aria-current="page" href="#!">대학 소개</a></li>
                        <li class="nav-item"><a class="nav-link" href="#!">학사 안내</a></li>
        ...
        <div class="container px-4 px-lg-5">
            ...
            <div class="card text-white bg-secondary my-5 py-4 text-center">
                <div class="card-body"><p class="text-white m-0">NAV BAR 확장해야 볼 수 있는 페이지 중 몇 가지를 선별해 퀵 서치로 이용할 수 있는 중앙 바 생성</p></div>
            </div>
            <!-- Content Row-->
        ...
        <footer class="py-5 bg-dark">
            <div class="container px-4 px-lg-5">
                <p class="m-0 text-center text-white">Copyright &copy; International College 2022</p>
                <p class="m-0 text-center text-white">대표전화 : 062.1234.5678 팩스 : 062.1234.5678 광주시 동구 필문대로 281 || 광주시 동구 백서로 175번길 8</p>
            </div>
        </footer>
        <!-- Bootstrap core JS-->
